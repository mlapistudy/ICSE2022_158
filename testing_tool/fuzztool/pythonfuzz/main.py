...
class PythonFuzz(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        parser.add_argument('--loc_file', type=str, default=None,
                            help='Count loc of which file. None refers not counting')
        ...
        #                   args.close_fd_mask, args.runs, args.mutator_filter, args.dict, args.loc_file)
        # Extra modify
        # force not using args.dirs
        f = fuzzer.Fuzzer(self.function, None, args.exact_artifact_path,
                          args.rss_limit_mb, args.timeout, args.regression, args.max_input_size,
                          args.close_fd_mask, args.runs, args.mutator_filter, args.dict, args.loc_file)
