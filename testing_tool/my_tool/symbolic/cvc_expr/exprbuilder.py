...
from symbolic.cvc_expr.floating import CVCFloat
from symbolic.symbolic_types import SymbolicInteger, SymbolicStr, SymbolicFloat
...
class ExprBuilder(object):
    ...
    def _getVariable(self, symbolic_var):
        ...
        elif isinstance(symbolic_var, SymbolicFloat):
            variable = CVCFloat.variable(name, self.solver)
    ...
    def _astToCVCExpr(self, expr, env=None):
        ...
        elif isinstance(expr, int) | isinstance(expr, str)  | isinstance(expr, float):
            if env is None:
                if isinstance(expr, int):
                    ...
                    return CVCFloat.constant(expr, self.solver)
            else:
                return expr
        elif expr is None:
            return None
